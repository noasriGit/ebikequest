...
export const virginiaTrails: Trail[] = [
  {
    ...
    description: "Ride 45 paved miles through Northern Virginia on the W&OD rail-trail—e-bikes welcome under NOVA Parks policy with a 20 mph powered-speed cap on the path.",
    ...EDITORIAL_DEFAULTS,
    ...
    ebikePolicy: {
      ...
      notes: "E-bikes are permitted on the W&OD Trail under Virginia state law and NOVA Parks trail policies for motorized bicycles that meet statutory definitions.",
    ...
    faq: [
      {
        ...
        answer: "Virginia law generally permits Class 3 e-bikes on shared-use paths unless a locality or agency prohibits them. NOVA Parks does not publish a separate Class 3 ban but requires all e-bikes to operate at no more than 20 mph under motor power on the trail. Practically, that means limiting assist on a Class 3 bike regardless of its 28 mph road capability."
      },
      {
        question: "Can I use the throttle on my Class 2 e-bike?",
        answer: "Virginia and NOVA Parks allow qualifying Class 2 e-bikes on the W&OD. Use throttle assist responsibly near pedestrians, and keep total motor-assisted speed at or below 20 mph on the path."
      },
      {
        question: "Where can I park for a one-way e-bike ride?",
        answer: "Popular shuttle pairs include Shirlington to Vienna, Reston to Leesburg, and Farmville-adjacent options are not on the W&OD—instead try Sterling to Purcellville. NOVA Parks lists official lots at Shirlington, Purcellville, and multiple Fairfax and Loudoun locations on its W&OD park page."
      },
      {
        question: "What hours is the W&OD open?",
        answer: "From Shirlington to Herndon, the trail is generally open 5 a.m. to 9 p.m. West of Herndon, hours follow dusk closing. Check NOVA Parks for seasonal adjustments."
      },
      {
        question: "Is the parallel horse trail open to e-bikes?",
        answer: "NOVA Parks directs electric conveyance users to areas where traditional bicycles are allowed. The paved main trail is the appropriate surface for e-bikes. The adjacent crushed-stone bridle path is primarily for equestrians and mountain bikers—confirm current signage before riding there."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Shirlington",
        notes: "South Four Mile Run Drive access; on-street parking; eastern terminus near I-395."
      },
      {
        name: "Vienna / Reston / Herndon",
        notes: "Multiple neighborhood lots and park connectors along the Fairfax corridor."
      },
      {
        name: "Ashburn",
        notes: "NOVA Parks headquarters and popular rest stop mid-trail."
      },
      {
        name: "Leesburg",
        notes: "Downtown access with dining and shops; good turnaround for moderate rides."
      },
      {
        name: "Purcellville West",
        notes: "Gravel lot on Hatcher Street near the western terminus."
      }
    ],
    seasonalNotes: "Open year-round; fixed 5 a.m.–9 p.m. hours east of Herndon and dusk closing west of Herndon. Expect heavy weekend use spring through fall, leaf-slick bridges in autumn, and occasional ice under overpasses in winter. Check NOVA Parks alerts for construction and tree work.",
  },
  {
    id: "trail-va-mount-vernon",
    slug: "mount-vernon-trail",
    title: "Mount Vernon Trail",
    description: "Scenic 18-mile Potomac riverfront trail from Mount Vernon to Roosevelt Island—Class 1 and 2 e-bikes allowed with NPS pedal-assist and 15 mph rules.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    ebikePolicy: {
      ...
      notes: "Class 1 and Class 2 e-bikes are generally permitted on the Mount Vernon Trail; verify current NPS and local posted rules before riding.",
      lastVerified: "2026-06-18"
    },
    amenities: [
      "scenic views",
    ...
    faq: [
      {
        ...
        answer: "No. NPS prohibits using the electric motor to move an e-bike without pedaling on GWMP trails except where public motor vehicles may drive. Operate Class 2 bikes in pedal-assist mode on the Mount Vernon Trail."
      },
      {
        question: "What is the speed limit on the Mount Vernon Trail?",
        answer: "NPS enforces a 15 mph speed limit on designated trails including the Mount Vernon Trail. That applies to e-bikes and conventional bicycles alike."
      },
      {
        question: "Are Class 3 e-bikes allowed?",
        answer: "NPS permits e-bikes meeting its definition where bicycles are allowed, and GWMP adopts Virginia law. However, the 15 mph trail limit and throttle-without-pedaling ban mean Class 3 capability above 15 mph must not be used on the path. Many riders on this trail use Class 1 or Class 2 bikes."
      },
      {
        question: "Where does the trail start and end?",
        answer: "The trail runs roughly 18 miles from Mount Vernon in Fairfax County to Theodore Roosevelt Island near Rosslyn and Key Bridge. Mile 0 markers and NPS place pages document major access nodes."
      },
      {
        question: "Can I ride from the Mount Vernon Trail into Washington, DC?",
        answer: "Bridge connections near Roosevelt Island and the 14th Street corridor link to DC, but rules change by jurisdiction. Verify DC DDOT guidance and NPS regulations for each segment before crossing the Potomac."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Mount Vernon",
        notes: "Southern terminus at George Washington's estate; paid estate parking may apply."
      },
      {
        name: "Belle Haven / Alexandria waterfront",
        notes: "Mid-trail river access with multiple parking areas."
      },
      {
        name: "Gravelly Point",
        notes: "Popular plane-spotting segment; crowded on weekends."
      },
      {
        name: "Theodore Roosevelt Island",
        notes: "Northern terminus area near Rosslyn and Key Bridge."
      }
    ],
    seasonalNotes: "Busy year-round with peak crowds spring through fall and on holidays. Summer heat and storms, winter ice on shaded bridges, and event-related parking limits affect planning. Confirm nps.gov/gwmp for closures.",
  },
  {
    id: "trail-va-powhatan",
    slug: "powhatan-state-park-trails",
    title: "Powhatan State Park Trails",
    description: "James River state park trails mix forest and river views—Class 1 and 2 e-bikes permitted only on bike-designated multi-use paths per Virginia DCR rules.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    ebikePolicy: {
      ...
      notes: "Class 1 e-bikes may be allowed on select multi-use trails; Class 2 and 3 restrictions may apply on natural surface trails.",
      lastVerified: "2026-06-18"
    },
    tags: [
      "state-park",
    ...
    faq: [
      {
        ...
        answer: "No. Bikes and e-bikes are limited to trails designated for bicycle use. Hiking-only trails such as River Trail and Gold Dust Trail prohibit cycling. Check the trail guide B designation before riding."
      },
      {
        question: "Are Class 3 e-bikes allowed?",
        answer: "No. Virginia State Parks administrative code limits authorized e-bikes to Class 1 and Class 2 on designated bicycle paths."
      },
      {
        question: "Do equestrians have priority?",
        answer: "Yes. On shared multi-use trails, yield to horses and hikers. Slow and announce your presence when approaching equestrians from behind."
      },
      {
        question: "Is there an entrance fee?",
        answer: "Powhatan State Park charges a daily parking fee unless you hold a Virginia State Parks annual pass. Fees support trail maintenance and staffing at the contact station."
      },
      {
        question: "What e-bike type works best here?",
        answer: "A Class 1 or Class 2 hardtail or trail-style e-MTB with moderate tires suits the natural surfaces better than a road-oriented e-bike."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Main contact station",
        notes: "4616 Powhatan State Park Road; primary parking and Entry Trail access."
      },
      {
        name: "Campground area",
        notes: "Campground Trail connects overnight visitors to bike-legal loops."
      },
      {
        name: "Equestrian trailer parking",
        notes: "Designated horse-trailer lots near multi-use trailheads."
      }
    ],
    seasonalNotes: "Best riding spring and fall; avoid bike-legal trails after heavy rain when closures protect tread. Summer brings heat and insects near the river. Verify trail status at the contact station during wet periods.",
  },
  {
    id: "trail-va-high-bridge",
    slug: "high-bridge-trail",
    title: "High Bridge Trail State Park",
    description: "31 miles of crushed limestone rail-trail capped by a 125-foot-high trestle—Class 1 and 2 e-bikes allowed on Virginia's iconic High Bridge Trail State Park.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    faq: [
      {
        ...
        answer: "No. Virginia State Parks administrative code restricts e-bikes to Class 1 and Class 2 on designated bicycle paths, including High Bridge Trail."
      },
      {
        question: "How far is it from Farmville to High Bridge?",
        answer: "About 4.5 miles one way from downtown Farmville to the bridge—roughly 9 miles round trip, a popular half-day e-bike outing."
      },
      {
        question: "Is drinking water available on the trail?",
        answer: "Very limited. Restrooms appear at intervals, but plan to fill bottles in Farmville or at trailheads before long rides."
      },
      {
        question: "Can horses and e-bikes share the trail?",
        answer: "Yes. Horses are permitted. Cyclists and e-bikers must yield, slow, and announce passes per DCR rail-trail etiquette."
      },
      {
        question: "What surface should I expect?",
        answer: "Finely crushed limestone, wide and generally flat—ideal for hybrids, gravel bikes, and mountain e-bikes."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Farmville River Road",
        notes: "555 River Road lot; about one mile from High Bridge; no trailers."
      },
      {
        name: "Farmville downtown",
        notes: "Main Street crossing near milepost 4.5; shops and rentals."
      },
      {
        name: "High Bridge Trail Station (Rice)",
        notes: "Camp Paradise Road access at the eastern bridge approach."
      },
      {
        name: "Prospect / Pamplin / Burkeville",
        notes: "Western and eastern terminus-area trailheads for long shuttles."
      }
    ],
    seasonalNotes: "Peak use March through November. Limestone softens after heavy rain; verify park status before long rides. Limited daylight in winter; carry layers for wind on the bridge deck.",
  },
  {
    id: "trail-va-new-river",
    slug: "new-river-trail-state-park",
    title: "New River Trail State Park",
    description: "57 miles of crushed-stone rail-trail along the New River in southwest Virginia—Class 1 and 2 e-bikes welcome; Class 3 prohibited in state parks.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    faq: [
      {
        ...
        answer: "Yes. The Foster Falls Boat and Bike Livery lists e-bike rentals on seasonal schedules—call 276-699-1034 for current availability, rates, and shuttle pairings."
      },
      {
        question: "Are Class 3 e-bikes allowed?",
        answer: "No. Virginia State Parks limit e-bikes to Class 1 and Class 2 on designated bicycle paths, including the New River Trail corridor."
      },
      {
        question: "How long does it take to ride the full 57 miles?",
        answer: "Most riders spread it over two or three days. E-bike assist reduces pedaling effort but plan for 5–8 hours of riding time if attempting the full length in one day, plus charging stops."
      },
      {
        question: "Are horses allowed on the trail?",
        answer: "Yes on most of the main corridor. Cyclists and e-bikers must yield to equestrians per DCR etiquette guidance."
      },
      {
        question: "Is the Hoover Mountain Biking Area open to e-bikes?",
        answer: "Hoover is a separate natural-surface system with different management. Confirm current bike and e-bike rules with park staff before riding there—do not assume the rail-trail policy applies."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Foster Falls",
        notes: "Central hub with livery, camping, inn, and river access."
      },
      {
        name: "Galax / Cliffview",
        notes: "Western trailhead with parking for long western segments."
      },
      {
        name: "Pulaski / Draper",
        notes: "Eastern access toward the Pulaski area."
      },
      {
        name: "Fries",
        notes: "Town trailhead on the Chestnut Creek segment."
      }
    ],
    seasonalNotes: "Livery and rentals run roughly April–October with daily summer service. Fall foliage peaks draw crowds; winter offers solitude with limited services. Check flood-related alerts after major river events.",
  },
  {
    id: "trail-va-belle-isle",
    slug: "james-river-park-belle-isle",
    title: "James River Park – Belle Isle Area",
    description: "Richmond riverfront singletrack and skills features on Belle Isle—verify e-bike rules; JRPS prohibits motorized vehicles on natural-surface trails.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    ebikePolicy: {
      ...
      notes: "E-bike access varies by trail segment within James River Park; natural surface trails may restrict throttle-assist bikes.",
      lastVerified: "2026-06-18"
    },
    tags: [
      "urban",
    ...
    faq: [
      {
        ...
        answer: "JRPS trail rules prohibit motorized vehicles, and the skills area requires non-motorized bicycles. Virginia law classifies qualifying e-bikes as bicycles, but the park has not published a clear e-bike exception. Contact Richmond Parks for current guidance before riding singletrack."
      },
      {
        question: "Where can I legally ride an e-bike near Richmond?",
        answer: "Virginia Capital Trail and many city streets follow statewide e-bike rules. Virginia State Parks with designated bike trails allow Class 1 and Class 2 e-bikes. JRPS natural surfaces require verification."
      },
      {
        question: "Can I use a Class 2 throttle on Belle Isle?",
        answer: "If riding is permitted at all, throttle use would conflict with non-motorized trail intent and pedestrian-heavy corridors. Default to Class 1 pedal-assist off-road or choose paved alternatives."
      },
      {
        question: "Is there parking at Belle Isle?",
        answer: "Riverfront lots near Tredegar and Texas Beach fill quickly on weekends. Consider riding from city neighborhoods or the Capital Trail network."
      },
      {
        question: "What are park hours?",
        answer: "James River Park System is open daily from dawn to dusk unless otherwise posted."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Tredegar / riverfront",
        notes: "Pedestrian bridge to Belle Isle; popular weekend parking."
      },
      {
        name: "Texas Beach trailhead",
        notes: "Mainland access to North Bank and connector routes."
      },
      {
        name: "Reedy Creek area",
        notes: "Southern JRPS access for longer MTB loops."
      }
    ],
    seasonalNotes: "Peak river use May through September; high-water closures at 5 feet on the James. Avoid riding wet singletrack after storms. Dawn-to-dusk access only.",
  },
  {
    id: "trail-va-skyline-drive-buffer",
    slug: "shenandoah-valley-rail-trail",
    title: "Shenandoah Valley Rail Trail",
    description: "Planned 49-mile Shenandoah Valley rail corridor from Broadway to Front Royal—project in development; check VDOT for status before planning e-bike trips.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    faq: [
      {
        ...
        answer: "No. The corridor remains an inactive rail line under study and negotiation. There is no continuous public trail open for bicycling as of 2026."
      },
      {
        question: "Will e-bikes be allowed when the trail opens?",
        answer: "Final rules are unsettled. If Virginia State Parks manages the trail, expect Class 1 and Class 2 authorization consistent with 4VAC5-30-276. Other managers could adopt broader § 46.2-904.1 defaults."
      },
      {
        question: "Where can I follow project updates?",
        answer: "Check VDOT's Shenandoah Valley Rail with Trail assessment page, shenandoahrailtrail.org, and the Shenandoah Valley Bike Coalition for public meeting announcements."
      },
      {
        question: "How long will the trail be?",
        answer: "Planning documents describe roughly 48–49 miles from Broadway to Front Royal through Rockingham, Shenandoah, and Warren counties."
      },
      {
        question: "What is rail-with-trail?",
        answer: "Rail-with-trail would build a path alongside a restored rail line rather than removing tracks entirely. VDOT's assessment compares costs and feasibility of that model against a traditional rail-to-trail conversion."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Broadway (planned)",
        notes: "Proposed southern terminus in Rockingham County— not open for trail use."
      },
      {
        name: "Woodstock (planned)",
        notes: "Mid-corridor town identified in feasibility studies."
      },
      {
        name: "Front Royal (planned)",
        notes: "Proposed northern terminus in Warren County."
      }
    ],
    seasonalNotes: "Trail not open. Monitor VDOT and Shenandoah Rail Trail Partnership for construction timelines. When built, expect peak use spring through fall in the Shenandoah Valley climate.",
  },
  {
    id: "trail-va-cape-henry",
    slug: "first-landing-state-park-trails",
    title: "First Landing State Park Trails",
    description: "Coastal Virginia Beach state park with 20 miles of forest trails—Class 1 and 2 e-bikes limited to Cape Henry and Live Oak bike-designated routes.",
    ...EDITORIAL_DEFAULTS,
    updatedAt: "2026-06-18",
    jurisdiction: "virginia",
    location: {
    ...
    faq: [
      {
        ...
        answer: "Only Cape Henry Trail and Live Oak Trail allow bicycles. Class 1 and Class 2 e-bikes permitted there must follow the same restriction. All other park trails and boardwalks are hiking-only."
      },
      {
        question: "Can I ride on the Bald Cypress boardwalk?",
        answer: "No. Bikes and e-bikes are prohibited on hiking trails including Bald Cypress. The boardwalk is for foot traffic only."
      },
      {
        question: "Are Class 3 e-bikes allowed?",
        answer: "No. Virginia State Parks administrative code limits e-bikes to Class 1 and Class 2 on designated bicycle paths."
      },
      {
        question: "Is there an entrance fee?",
        answer: "First Landing charges a daily parking fee unless you hold a Virginia State Parks annual pass. As Virginia's busiest park, expect queues on summer mornings."
      },
      {
        question: "Can I ride my e-bike on the beach?",
        answer: "Beach riding rules vary seasonally in Virginia Beach tourist areas. First Landing beach access is primarily for walking and swimming—confirm current ordinances before riding sand anywhere in the resort district."
      }
    ],
    highlights: [
    ...
    accessPoints: [
      {
        name: "Trail Center",
        notes: "2500 Shore Drive; maps and bike-legal route information."
      },
      {
        name: "Cape Henry Trail north lot",
        notes: "Common starting point for the six-mile bike corridor."
      },
      {
        name: "Campground access",
        notes: "Overnight visitors can reach Live Oak and Cape Henry connectors."
      }
    ],
    seasonalNotes: "Summer crowds and afternoon storms; spring birding season on hiking-only trails. Hurricane closures possible fall season. Winter riding is quiet with limited daylight.",
  },
];
